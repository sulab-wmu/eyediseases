...
import {getGtexUrls, parseGeneExpressionForViolin, parseGenes, parseMedianExpression, parseTissues, parseTissueSites,} from "./modules/gtexDataParser";

import {createTissueGroupMenu, createTissueMenu, parseTissueGroupMenu} from "./modules/gtexMenuBuilder";
...
function _renderViolinHelper(data, dmap, tissueDict) {
    ...
    let tissueOrder = dmap.objects.heatmap.xScale.domain().map((d, i) => {
        return {id: d, name: tissueDict[d].tissueSiteDetail}
    });
