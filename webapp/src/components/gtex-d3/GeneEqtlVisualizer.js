...
import {getGtexUrls, parseExonsToList, parseGenes, parseLD, parseSingleTissueEqtls, parseTissueDict, parseTissueSampleCounts} from "./modules/gtexDataParser";
...
function renderTssDistanceTrack(gene, bmap, bmapSvg) {
    ...
    let domain = [0.000001, 0.005, 0.01, 0.1, 0.5, 2, 3, 4, 5].map(function (d) {
        return d * unit
    });
